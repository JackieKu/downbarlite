...
pref("downbar.style.db_finishedHbox", "background-color:#89AFDB;max-width:135px;max-height:20px;min-height:20px;background-image:url(chrome://downbarlite/skin/whiteToTransGrad.png);-moz-border-radius:2px;border:1px solid threeDShadow;margin-top:1px;margin-bottom:1px;margin-left:2px;margin-right:1px;padding-top:0px;padding-bottom:0px;padding-left:3px;padding-right:0px;");
pref("downbar.style.db_notdoneHbox", "background-color:#A3A3A3;max-width:135px;max-height:20px;min-height:20px;background-image:url(chrome://downbarlite/skin/whiteToTransGrad.png);-moz-border-radius:2px;border:1px solid threeDShadow;margin-top:1px;margin-bottom:1px;margin-left:2px;margin-right:1px;padding-top:0px;padding-bottom:0px;padding-left:3px;padding-right:0px;");
...
pref("downbar.style.db_progressbar", "background-color:#89AFDB;background-image:url(chrome://downbarlite/skin/whiteToTransGrad.png);border-right:0px solid transparent;");
...
pref("extensions.{D4DD63FA-01E4-46a7-B6B1-EDAB7D6AD389}.description", "chrome://downbarlite/locale/downbar.properties");
